      ...
      <div className="relative hidden lg:flex lg:w-[60%] bg-zinc-900 overflow-hidden">
        {slides.map((slide, index) => (
          ...
          >
            ...
            <img src={slide.url} alt="Beauty Background" className="h-full w-full object-cover" />
        ...
        <div className="mt-12 text-center">
          <p className="text-[10px] font-bold text-zinc-400 tracking-[0.2em] uppercase">
            ...
            <span 
              ...
              className="cursor-pointer hover:underline underline-offset-4 font-black transition-colors"
              style={{ color: "#B799FF" }}
            >
              Create Account
            </span>
