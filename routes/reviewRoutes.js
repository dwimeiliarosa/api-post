 ...
 * /reviews/{id}:
 *   delete:
 *     summary: Hapus review dan foto terkait di MinIO
 *     tags: [Reviews]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: integer
 *         description: ID unik dari review yang ingin dihapus
 *     responses:
 *       200:
 *         description: Review dan file berhasil dihapus
 *       403:
 *         description: Forbidden (Bukan pemilik ulasan)
 *       404:
